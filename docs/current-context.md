...
- `public/robots.txt` allows crawlers and points to `https://andy.dailyturning.com/sitemap.xml`; `public/sitemap.xml` lists the canonical production homepage plus 6 SEO content routes.
