...
- All five dinosaur stages now use real four-frame raster animation: the egg progressively cracks, the baby blinks and waves, the young dinosaur dances with its note, the adult breathes and flutters its scarf, and the super dinosaur blinks, powers up, and moves its cape. Per-frame alignment metadata normalizes subject scale, center, and baseline so pose changes do not make the pet jump around. The React player pauses in hidden tabs and respects reduced-motion preferences.
